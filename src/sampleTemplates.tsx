  ...
  [
    {
      ...
      isHovered: false,
      moisture: [
        dataset.moisture[1][0],
        dataset.moisture[1][1],
        dataset.moisture[1][2],
      ],
    ...
    },
    {
      ...
      isHovered: false,
      moisture: [
        dataset.moisture[10][0],
        dataset.moisture[10][1],
        dataset.moisture[10][2],
      ],
    ...
    },
    {
      ...
      isHovered: false,
      moisture: [
        dataset.moisture[14][0],
        dataset.moisture[14][1],
        dataset.moisture[14][2],
      ],
